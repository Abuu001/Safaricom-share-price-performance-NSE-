...
const Tracker =()=>{
 //ytd
  const    [YTD_all_share_index,setYTD_All_share_index]=useState(0)
  const    [YTD_twenty_share_index,setYTD_Twenty_share_index]=useState(0)
  const    [YTD_market_cap,setYTD_Market_cap]=useState(0)
  const    [YTD_twenty_five_share_index,setYTD_Twenty_five_share_index]=useState(0)
  const    [YTD_price,setYTD_price]=useState(0)
  const    [YTD_instrument_market_cap,setYTD_instrument_market_cap]=useState(0)

  //2weeks
  const    [_2_Weeks_all_share_index,set2Weeks_All_share_index]=useState(0)
  const    [_2_Weeks_twenty_share_index,set2Weeks_Twenty_share_index]=useState(0)
  const    [_2_Weeks_market_cap,set2Weeks_Market_cap]=useState(0)
  const    [_2_Weeks_twenty_five_share_index,set2Weeks_Twenty_five_share_index]=useState(0)
  const    [_2_Weeks_price,set2Weeks_price]=useState(0)
  const    [_2_instrument_market_cap,set2Weeks_instrument_market_cap]=useState(0)

   //1 month
   const    [_1_month_all_share_index,set_1_month_All_share_index]=useState(0)
   const    [_1_month_twenty_share_index,set_1_month_Twenty_share_index]=useState(0)
   const    [_1_month_market_cap,set_1_month_Market_cap]=useState(0)
   const    [_1_month_twenty_five_share_index,set_1_month_Twenty_five_share_index]=useState(0)
   const    [_1_month_price,set_1_month_price]=useState(0)
   const    [_1_month_instrument_market_cap,set_1_month_instrument_market_cap]=useState(0)

   //3month
   const    [_3_month_all_share_index,set_3_month_All_share_index]=useState(0)
   const    [_3_month_twenty_share_index,set_3_month_Twenty_share_index]=useState(0)
   const    [_3_month_market_cap,set_3_month_Market_cap]=useState(0)
   const    [_3_month_twenty_five_share_index,set_3_month_Twenty_five_share_index]=useState(0)
   const    [_3_month_price,set_3_month_price]=useState(0)
   const    [_3_month_instrument_market_cap,set_3_month_instrument_market_cap]=useState(0)

    //6month
    const    [_6_month_all_share_index,set_6_month_All_share_index]=useState(0)
    const    [_6_month_twenty_share_index,set_6_month_Twenty_share_index]=useState(0)
    const    [_6_month_market_cap,set_6_month_Market_cap]=useState(0)
    const    [_6_month_twenty_five_share_index,set_6_month_Twenty_five_share_index]=useState(0)
    const    [_6_month_price,set_6_month_price]=useState(0)
    const    [_6_month_instrument_market_cap,set_6_month_instrument_market_cap]=useState(0)


    //12month
    const    [_12_month_all_share_index,set_12_month_All_share_index]=useState(0)
    const    [_12_month_twenty_share_index,set_12_month_Twenty_share_index]=useState(0)
    const    [_12_month_market_cap,set_12_month_Market_cap]=useState(0)
    const    [_12_month_twenty_five_share_index,set_12_month_Twenty_five_share_index]=useState(0)
    const    [_12_month_price,set_12_month_price]=useState(0)
    const    [_12_month_instrument_market_cap,set_12_month_instrument_market_cap]=useState(0)


    //2 yrs
    const    [_2_years_all_share_index,set_2_years_All_share_index]=useState(0)
    const    [_2_years_twenty_share_index,set_2_years_Twenty_share_index]=useState(0)
    const    [_2_years_market_cap,set_2_years_Market_cap]=useState(0)
    const    [_2_years_twenty_five_share_index,set_2_years_Twenty_five_share_index]=useState(0)
    const    [_2_years_price,set_2_years_price]=useState(0)
    const    [_2_years_instrument_market_cap,set_2_years_instrument_market_cap]=useState(0)

    //3 yrs
    const    [_3_years_all_share_index,set_3_years_All_share_index]=useState(0)
    const    [_3_years_twenty_share_index,set_3_years_Twenty_share_index]=useState(0)
    const    [_3_years_market_cap,set_3_years_Market_cap]=useState(0)
    const    [_3_years_twenty_five_share_index,set_3_years_Twenty_five_share_index]=useState(0)
    const    [_3_years_price,set_3_years_price]=useState(0)
    const    [_3_years_instrument_market_cap,set_3_years_instrument_market_cap]=useState(0)

    //5 yrs
    const    [_5_years_all_share_index,set_5_years_All_share_index]=useState(0)
    const    [_5_years_twenty_share_index,set_5_years_Twenty_share_index]=useState(0)
    const    [_5_years_market_cap,set_5_years_Market_cap]=useState(0)
    const    [_5_years_twenty_five_share_index,set_5_years_Twenty_five_share_index]=useState(0)
    const    [_5_years_price,set_5_years_price]=useState(0)
    const    [_5_years_instrument_market_cap,set_5_years_instrument_market_cap]=useState(0)
   ...
   const [isLoading,setIsLoading] =useState(false)
    ...
    return(
       <div className="ovf" >
          {
             isLoading ? <TrackerTable/> :  <Spinner/>
          }
        </div>
    )   
}
